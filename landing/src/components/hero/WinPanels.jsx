...
const RECENT = [
  { n: "JumpStart", s: "2 subprocesses", d: "JumpStart is a multi os control panel that helps m…", m: "29m ago" },
  { n: "PeepalRP", s: "2 subprocesses", d: "PeepalRP is a comprehensive sales and marketing p…", m: "9h ago" },
  { n: "Defiance Smart Chain", s: "3 subprocesses", d: "This project is a scalable blockchain platform…", m: "1d ago" },
  { n: "Consent Manager Platform", s: "5 subprocesses", d: "The Consent Manager Platform is a modular monoli…", m: "3d ago" },
];
const MOST_USED = [
  { n: "Defiance Smart Chain", s: "3 subprocesses", d: "This project is a scalable blockchain platform…", m: "4 starts" },
  ...
  { n: "JumpStart", s: "2 subprocesses", d: "JumpStart is a multi os control panel that helps ma…", m: "1 starts" },
];
